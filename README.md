...
### Codes
The first code "Ballestic" calculates the roughness of the interface where we could find the exponent beta  and "Ah"  which is called the "GROWTH EXPONENT" and "ROUGHNESS EXPONENT" respectively.
